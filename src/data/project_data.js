...
const project_list = [
  {
    ...
    demonstrated_capabilities: [
      {
        title:
          "Ability to create a REST API and fetch data on client's request.",
        status_icon: status_icons.done.icon,
        status: 'done',
      },
      {
        title:
          'Ability to create a full-stack web application, with a decoupled front-end/back-end.',
        status_icon: status_icons.done.icon,
        status: 'done',
      },
      {
    ...
    live_link: null,
    description:
      "AU7OMA7A-BI enables business owners and conscientious professionals to collect, manage, and analyze data pertaining to individuals', or organizations' successes in their career or business ventures.",
    stack: [
      {
        title: 'Django',
    ...
    media_files: [au7oma7a_bi_pic, au7oma7a_bi_pic_2],
  },
  {
    title: 'BeatCommerce',
    ...
    demonstrated_capabilities: [
      {
        title:
          'Translated client requirements into executable, technical requirements.',
        status_icon: status_icons.done.icon,
        status: 'done',
      },
      {
      ...
      {
        title:
          'Create Django REST API to connect to React in a loosely coupled fashion.',
        status_icon: status_icons.in_progress.icon,
        status: 'in progress',
      },
    ],
    ...
    description:
      'The BeatCommerce platform is an e-commerce store for music producers.',
    stack: [
      {
        title: 'Python',
        icon: logos_dict['python'],
  ...
  },
  {
    ...
    repo_link: '',
    description:
      'Netwyrk is a social media/marketplace platform for entrepreneurs and freelancers.',
    stack: [
      {
        title: 'Django',
        icon: logos_dict['django'],
  ...
  },
  {
    ...
    description:
      'Portfolio Two is a software engineering/web development portfolio.',
    features: [
      {
  ...
  },
  {
    ...
    media_files: [portfolio_one_pic, portfolio_one_pic_1, portfolio_one_pic_2],
    roadmap: [
      {
  ...
  },
  {
    ...
    media_files: [neohacker_pic, neohacker_pic_1],
    features: [
      {
