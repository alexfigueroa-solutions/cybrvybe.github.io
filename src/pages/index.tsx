...
import './index.scss';
import AnimatedTyper from '../components/AnimatedTyper/animated_typer';
      ...
      <div className="metaWrapper">
        ...
        <div className="landingWrapper">
          <div className="landingDiv">
            ...
            >
              <AnimatedTyper
                prompt="I Implement Technical Solutions to Business Problems"
                font="CarbonBl"
                font-size="7"
              ></AnimatedTyper>
            </div>
